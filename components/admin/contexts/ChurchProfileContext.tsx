...
// Apply CSS vars + dark class to <html> — always called outside render
...
export const ChurchProfileProvider = ({ children }: { children: ReactNode }) => {
  // Initialise directly from localStorage so there is NO intermediate render
  // with stale defaults — this avoids the setState-in-effect pattern entirely.
  ...
  // Apply global styles synchronously before first paint (no flash)
  useLayoutEffect(() => {
