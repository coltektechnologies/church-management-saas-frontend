        ...
        {activities.map((activity) => (
          ...
          >
            <div className="flex flex-col gap-2.5">
              <h3 className="text-[17px] font-bold text-foreground tracking-tight">{activity.title}</h3>
              <div className="flex flex-col items-start text-[13px] font-medium text-slate-600 dark:text-slate-400">
                <div className="flex items-center gap-2">
                  <CalendarDays className="h-4 w-4 text-slate-700 dark:text-slate-300" strokeWidth={1.75} />
                  <span>{activity.date}</span>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-slate-700 dark:text-slate-300" strokeWidth={1.75} />
            ...
            <div className="flex flex-row justify-between md:flex-col items-start md:items-end gap-3.5">
              ...
              <div className="flex items-center gap-3 text-slate-600 dark:text-slate-400">
                ...
                <button className="hover:text-foreground transition-colors cursor-pointer p-1 hover:bg-secondary/80 rounded-md" title="Manage Members">
