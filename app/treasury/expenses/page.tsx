...
export default function ExpenseRecordingPage() {
  return (
    <div className="flex flex-col gap-6 p-6 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <ArrowUpCircle size={22} color="#2FC4B2" />
        </div>
        <div>
          <h1 className="text-2xl font-black text-foreground">Expense Recording</h1>
          <p className="text-sm text-muted-foreground font-medium">
            Record and categorise outgoing expenses.
          </p>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-[20px] p-10 flex flex-col items-center justify-center gap-4 text-center min-h-[320px] shadow-sm">
        <ArrowUpCircle size={48} className="text-muted-foreground/40" />
        <p className="text-base font-semibold text-muted-foreground">
          Expense Recording — coming soon
        </p>
