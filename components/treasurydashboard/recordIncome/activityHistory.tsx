...
export function actionColor(action: ActivityAction): string {
  if (action.startsWith('income_recorded')) {
    return '#15803D';
  }
  if (action.startsWith('income_edited')) {
    return '#D97706';
  }
  if (action.startsWith('income_deleted')) {
    return '#DC2626';
  }
  if (action.startsWith('income_printed')) {
    return '#2563EB';
  }
  if (action.startsWith('dropdown_option_added')) {
    return '#15803D';
  }
  if (action.startsWith('dropdown_option_edited')) {
    return '#D97706';
  }
  if (action.startsWith('dropdown_option_removed')) {
    return '#DC2626';
  }
