...
/**
 * DeptColorThemeTab — identical UX to secretary's ColorThemeTab
 * but wired to DepartmentProfileContext & uses dept CSS vars.
 *
 * Reuses PaletteGrid from the secretary settings (path:
 * @/components/secretary/settings/PaletteGrid) so palette/custom
 * tabs stay consistent across the whole app.
 */
...
// Reuse the secretary PaletteGrid — same palettes, same UX.
...
export default function DeptColorThemeTab() {
