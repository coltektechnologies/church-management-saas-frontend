      ...
      >
        ...
        <div ref={printRef} style={{ padding: '24px' }}>
          <div style={{ maxWidth: '440px', margin: '0 auto', fontFamily: "'Poppins',sans-serif" }}>
            ...
            {/* Church header */}
            <div style={{ textAlign: 'center', paddingBottom: '20px', marginBottom: '20px', borderBottom: `2px dashed ${headerBorder}` }}>
              <div style={{ fontWeight: 700, fontSize: '18px', color: textColor }}>{churchName}</div>
              <div style={{ fontSize: '11px', color: subtleText, marginTop: '2px' }}>{churchAddress}</div>
              <div style={{ fontSize: '11px', fontWeight: 600, color: accentColor, marginTop: '12px', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                Official Income Receipt
              </div>
              <div style={{ fontSize: '22px', fontWeight: 700, color: textColor, marginTop: '4px' }}>
            ...
            >
              <span style={{ fontSize: '12px', fontWeight: 600, color: accentColor }}>AMOUNT RECEIVED</span>
            ...
            {([
              ...
              { label: 'Income Type',    value: incomeTypeLabel(record.incomeType, record.incomeTypeDetail) },
              { label: 'Member',         value: record.memberName },
              { label: 'Payment Method', value: paymentLabel(record.paymentMethod, record.paymentDetail) },
              ...
              >
                <span style={{ fontSize: '11px', color: subtleText, fontWeight: 500, flexShrink: 0 }}>{label}</span>
                <span style={{ fontSize: '12px', color: textColor, fontWeight: 600, textAlign: 'right', maxWidth: '60%' }}>{value}</span>
              </div>
            ))}

            {/* Footer */}
            <div style={{ textAlign: 'center', marginTop: '20px', paddingTop: '16px', borderTop: `2px dashed ${headerBorder}` }}>
              <p style={{ fontSize: '10px', color: subtleText }}>Thank you for your generous contribution.</p>
              <p style={{ fontSize: '10px', color: subtleText, marginTop: '2px' }}>This is an official receipt. Please keep it for your records.</p>
            </div>
          </div>
        </div>
