  ...
  const validateField = (name: keyof FormData, value: string): string | undefined => {
    switch (name) {
      ...
      case 'category':
        ...
        break;
      case 'justification':
        if (!value.trim()) {return 'Justification is required';}
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-12 pr-4 py-3 bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${touched.firstName && errors.firstName
                            ? 'border-red-500'
                            : 'border-gray-200'
                          }`}
                      />
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-12 pr-4 py-3 bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${touched.serviceNumber && errors.serviceNumber
                            ? 'border-red-500'
                            : 'border-gray-200'
                          }`}
                      />
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={`w-full px-4 py-3 bg-white border rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${touched.category && errors.category
                            ? 'border-red-500'
                            : 'border-gray-200'
                          }`}
                      >
