...
// Treasury-specific tabs (use TreasuryProfileContext internally)
import MyProfileTab from '@/components/treasurydashboard/settings/MyProfileTab';
import ColorThemeTab from '@/components/treasurydashboard/settings/ColorThemeTab';
import SystemPreferencesTab from '@/components/treasurydashboard/settings/SystemPreferencesTab';

// These tabs have no profile reads — safe to reuse from secretary
...
export default function TreasurySettingsPage() {
  ...
  const go = (value: string) => router.push(`/treasury/settings?tab=${value}`, { scroll: false });
