...
export default function RecordIncomePage() {
  ...
  const pageBg       = isDark ? (profile.darkBackgroundColor || '#0B1D35') : (profile.backgroundColor || '#EEF2F7');
    ...
    setEntryLog((prev) => {
      ...
      if (old) {
        ...
        if (old.amount !== updated.amount)
          { changes.push(`amount ${getCurrencySymbol(old.currency)}${old.amount} → ${getCurrencySymbol(updated.currency)}${updated.amount}`); }
  ...
  const navBtn: React.CSSProperties = {
    ...
    fontFamily: "'OV Soge', sans-serif", fontWeight: 600, fontSize: '12px',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => { const b = e.currentTarget; b.style.backgroundColor = `${accentColor}10`; b.style.borderColor = accentColor; b.style.color = accentColor; }}
            onMouseLeave={(e) => { const b = e.currentTarget; b.style.backgroundColor = 'transparent'; b.style.borderColor = borderColor; b.style.color = textColor; }}
          >
      ...
      <div style={{
        ...
        {entryLog.length > 0 ? (
          ...
          <div style={{
            ...
            <p style={{ fontFamily: "'OV Soge',sans-serif", fontSize: '13px', color: `${textColor}45`, margin: 0 }}>
