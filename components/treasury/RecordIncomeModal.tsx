...
export function IncomeForm({ onOpenChange }: { onOpenChange?: (open: boolean) => void }) {
              ...
              <FormItem className="space-y-1.5">
                ...
                <FormControl>
                  <div className="relative">
                    <Input
                      type="date"
                      className="bg-transparent border-slate-200 rounded-xl h-11 text-[14px] pl-4 pr-11 focus-visible:ring-1 focus-visible:ring-[#28c1a6] focus-visible:border-[#28c1a6] [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:right-0 [&::-webkit-calendar-picker-indicator]:w-10 [&::-webkit-calendar-picker-indicator]:h-full [&::-webkit-calendar-picker-indicator]:cursor-pointer"
                      {...field}
                    />
            ...
            render={({ field }) => (
              <FormItem className="space-y-1.5">
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger className="bg-transparent border-slate-200 rounded-xl h-11 text-[14px] focus:ring-1 focus:ring-[#28c1a6] focus:border-[#28c1a6]">
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="flex flex-col text-[#0f2846]">
          ...
          {/* Form Content */}
          <IncomeForm onOpenChange={onOpenChange} />
        </div>
      </DialogContent>
    </Dialog>
  );
