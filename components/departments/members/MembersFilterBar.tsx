          ...
          {options.map((opt) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  if (!selected) {
                    (e.currentTarget as HTMLButtonElement).style.background = `${STROKE}55`;
                  }
                }}
                onMouseLeave={(e) => {
                  if (!selected) {
...
function RoleComboBox({
  ...
  const filtered = ROLE_SUGGESTIONS.filter((s) =>
    s === 'All' || !value || value === 'All' ? true : s.toLowerCase().includes(value.toLowerCase())
  );
    ...
    <div ref={wrapRef} style={{ position: 'relative', flexShrink: 0, minWidth: '160px' }}>
      ...
      {open && (
        ...
        >
          ...
          {displayValue &&
            !ROLE_SUGGESTIONS.some((s) => s.toLowerCase() === displayValue.toLowerCase()) && (
              <div
                style={{
                  padding: '9px 14px',
                  fontSize: '11px',
    ...
    >
      ...
      <div className="relative flex items-center flex-1" style={{ minWidth: '180px' }}>
        ...
        <input
          ...
          onBlur={(e) => {
            (e.currentTarget as HTMLInputElement).style.borderColor = STROKE;
          }}
        />
        {values.search && (
          <button
