  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={`text-[13px] leading-snug truncate ${!n.read ? 'font-semibold text-[#0B2A4A]' : 'font-normal text-gray-400'}`}
    ...
    <header className="h-14 md:h-16 bg-white dark:bg-[#253347] border-b border-gray-200 dark:border-white/10 flex items-center justify-between px-3 md:px-6 sticky top-0 z-20 transition-colors duration-300 gap-2">
      ...
      <div className="flex items-center gap-0.5 md:gap-1 shrink-0">
        ...
        <div className="relative hidden md:block" ref={helpRef}>
          <button
            onClick={() => toggle('help')}
            className="w-8 h-8 md:w-9 md:h-9 rounded-full flex items-center justify-center text-gray-500 hover:bg-gray-100 transition-colors"
          >
            <HelpCircle size={17} />
          </button>
          {helpOpen && (
            <div className="absolute top-full right-0 mt-2 w-52 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 overflow-hidden">
              ...
              {[
                ...
                <Link
                  ...
                  className="flex items-center justify-between px-4 py-2.5 text-gray-600 hover:bg-gray-50 transition-colors"
                >
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="relative w-8 h-8 md:w-9 md:h-9 rounded-full flex items-center justify-center text-gray-500 hover:bg-gray-100 transition-colors"
          >
            <Bell size={17} />
            {unreadCount > 0 && (
              <span
          ...
          {notifHover && !notifOpen && unread.length > 0 && (
            <div className="absolute top-full right-0 mt-2 w-64 md:w-72 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden pointer-events-none">
              <p className="px-4 py-2 text-[11px] font-semibold text-gray-400 uppercase tracking-widest border-b border-gray-100">
                {unreadCount} unread
              </p>
          ...
          {notifOpen && (
            <div className="absolute top-full right-0 mt-2 w-72 md:w-80 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                <p className="text-[#0B2A4A] font-bold text-[14px]">
                  Notifications
                  {unreadCount > 0 && (
                    <span
        ...
        <div className="relative ml-0.5 md:ml-1" ref={profileRef}>
          <button
            ...
            className="flex items-center gap-1.5 md:gap-2 px-1.5 md:px-2 py-1 md:py-1.5 rounded-xl hover:bg-gray-50 transition-colors"
          >
            <NavAvatar
              size={30}
          ...
          {profileOpen && (
            <div className="absolute top-full right-0 mt-2 w-64 md:w-72 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 overflow-hidden">
              <div
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p
                      className="text-[#0B2A4A] font-bold text-[14px] truncate"
                      style={{ fontFamily: 'Poppins, sans-serif' }}
                    >
                      {adminName}
                    </p>
                    <p className="text-gray-400 text-[12px] truncate">{adminEmail}</p>
                    <span
              ...
              {/* Mobile dark toggle */}
              <div className="px-4 py-2 border-t border-gray-100 flex items-center justify-between sm:hidden">
              ...
              <div className="px-4 py-2.5 border-t border-gray-100 bg-gray-50">
                ...
                <p className="text-[13px] font-semibold text-[#0B2A4A] truncate">{churchName}</p>
                {mounted && (
                  <span
